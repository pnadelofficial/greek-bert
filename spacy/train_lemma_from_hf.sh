...
spacy train configs/gpu_default_freq_lemma.cfg --paths.train corpus/train.spacy --paths.dev corpus/dev.spacy --code "custom_components/lemmatizer.py" --gpu-id 0 --output ./output
