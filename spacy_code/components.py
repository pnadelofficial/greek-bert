# copied from odycy: https://github.com/centre-for-humanities-computing/odyCy/blob/main/custom_components/lemmatizer.py
import os
import json
...
import spacy_transformers # needed for packaging
